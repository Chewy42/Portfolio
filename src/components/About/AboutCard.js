...
import { FaGraduationCap, FaCode, FaBriefcase, FaGithub, FaFlask, FaUsers } from "react-icons/fa";
      ...
      <div className="p-8 space-y-8">
          ...
          <div className="space-y-8 pl-4 border-l-2 border-[#c770f0]">
            ...
            <div className="space-y-4">
              <div className="flex flex-col md:flex-row md:justify-between items-start md:items-center gap-2">
                <h3 className="text-lg font-medium text-[#c770f0]">Undergraduate Researcher, Grand Challenges Initiative</h3>
            ...
            <div className="space-y-4">
              <div className="flex flex-col md:flex-row md:justify-between items-start md:items-center gap-2">
                <h3 className="text-lg font-medium text-[#c770f0]">Johnson & Johnson Workforce Ready Program</h3>
                <span className="text-gray-300 bg-[#c770f0] bg-opacity-10 px-4 py-1 rounded-full text-sm whitespace-nowrap">
                  Spring 2023
                </span>
              </div>
        ...
        <div className="space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="p-4 rounded-lg bg-[#c770f0] bg-opacity-10 hover:bg-opacity-20 transition-all">
              ...
              <p className="text-gray-300">Tensorflow, PyTorch, Pandas, NumPy, Sklearn, OpenCV</p>
            </div>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4 pl-4 border-l-2 border-[#c770f0]">
            <div className="flex flex-col md:flex-row md:justify-between items-start md:items-center gap-2">
              <h3 className="text-lg font-medium text-[#c770f0]">Chapman IEEE Branch</h3>
              <span className="text-gray-300 bg-[#c770f0] bg-opacity-10 px-4 py-1 rounded-full text-sm whitespace-nowrap">
                President • August 2022 - May 2024
              </span>
            </div>
            <div className="flex flex-col md:flex-row md:justify-between items-start md:items-center gap-2">
              <h3 className="text-lg font-medium text-[#c770f0]">Chapman VR/AR Club</h3>
              <span className="text-gray-300 bg-[#c770f0] bg-opacity-10 px-4 py-1 rounded-full text-sm whitespace-nowrap">
                President • August 2022 - May 2024
              </span>
            </div>
